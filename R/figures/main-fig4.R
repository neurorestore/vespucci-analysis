...
# housekeeper genes
sc = readRDS('data/real_data/seurat/regen_final.rds')
sc@meta.data %<>%
    mutate(
...
ves_dir = 'data/real_data/vespucci/'
comparison_names = c(
...
rctd_res = readRDS('data/real_data/rctd/regen_final/rctd-res-layer1.rds') %>%
    filter(
...
seurat_go_dir = 'data/real_data/seurat_GO/DE/'
